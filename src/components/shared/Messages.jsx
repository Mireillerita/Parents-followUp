...
const Messages = () => {
  ...
  const fetchMessages = async () => {
    try {
      const response = await axios.get('https://parents-follow-u.onrender.com/followup/contactus/listMessage'); // Adjust the URL to your API endpoint
  ...
  const deleteMessage = async (id) => {
    try {
      await axios.delete(`https://blood-link-be.onrender.com/followup/contactus/deleteMessage/${id}`); // Adjust the URL to your API endpoint
  ...
  return (
    <div className="container mx-auto px-4">
      <h2 className="text-2xl font-bold mb-4">Messages from parents</h2>
